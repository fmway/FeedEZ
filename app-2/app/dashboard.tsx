...
export default function DashboardScreen() {
  ...
  return (
    <View style={styles.container}>
      ...
      {/* Pindah ke /schedule */}
      <Link href={"/schedule"} style={[styles.button, styles.scheduleButton]}>
        <Text style={[styles.buttonText, { "textAlign" : "center" }]}>Lihat Jadwal</Text>
      </Link>
      ...
      >
          <Text style={[styles.buttonText, { "textAlign": "center" }]}>Pengaturan</Text>
      </Link>
    </View>
  );
}
